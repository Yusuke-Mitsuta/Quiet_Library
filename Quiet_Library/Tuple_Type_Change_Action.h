...
namespace quiet::N_Tuple
{
		...
		requires requires
	{
		...
		//requires T_Tuple::name == N_Constexpr::String{ "" };
	}
	struct S_Tuple_Type_Change_Action<t_Action_Type_Tuple_p,false,t_Action_break,T_Action,T_Tuple>
	{
		using return_type= S_Tuple_Type_Change_Action<t_Action_Type_Tuple_p, false, t_Action_break, T_Action, U_Tuple_t_To_v<T_Tuple>>::type;
	...
	struct S_Tuple_Type_Change_Action<true, t_Action_Type_Tuple_t, t_Action_break, T_Action, T_Tuple>
	{
		using return_type = S_Tuple_Type_Change_Action<true,t_Action_Type_Tuple_t ,t_Action_break, T_Action,U_Create_p<T_Tuple>>::type;
	...
	struct S_Tuple_Type_Change_Action<t_Action_Type_Tuple_p, true,t_Action_break, T_Action, T_Tuple>
	{
		using return_type = S_Tuple_Type_Change_Action<t_Action_Type_Tuple_p, true, t_Action_break, T_Action, U_Tuple_v_To_t<T_Tuple>>::type;
	...
	struct S_Tuple_Type_Change_Action<false,t_Action_Type_Tuple_t, t_Action_break, T_Action, T_Tuple>
	{
		using return_type = S_Tuple_Type_Change_Action<false,t_Action_Type_Tuple_t, t_Action_break, T_Action, U_Remove_p<T_Tuple>>::type;
