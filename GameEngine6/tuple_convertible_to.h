...
template<class ...C_Flom_Flont_Tuple, class ...C_Flom, class C_To_Flont, class ...C_To>
struct S_tuple_convertible_to<
	std::tuple<std::tuple<C_Flom_Flont_Tuple...>,C_Flom...>, 
	std::tuple<C_To_Flont, C_To...>>
{
	using Type = S_tuple_convertible_to<std::tuple<C_Flom_Flont_Tuple...,C_Flom...>, std::tuple<C_To...>>::Type;
};

template<class C_Flom_Flont, class ...C_Flom, class ...C_To_Flont_Tuple, class ...C_To>
struct S_tuple_convertible_to<
	std::tuple<C_Flom_Flont, C_Flom...>, 
	std::tuple<std::tuple<C_To_Flont_Tuple...>, C_To...>>
{
	using Type = S_tuple_convertible_to<std::tuple<C_Flom_Flont,C_Flom...>, std::tuple<C_To_Flont_Tuple...,C_To...>>::Type;
};
...
template<class _Flom, class _To>
concept tuple_convertible_to = std::same_as<std::true_type,typename S_tuple_convertible_to<_Flom, _To>::Type>;
