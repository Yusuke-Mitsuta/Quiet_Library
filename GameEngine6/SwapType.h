...
//仕様
//Judgeの判定に[T_Concept]を使用し、その結果がtrueなら[_Ty1],falseなら[invalid_t]
//
//template
//_Ty1::判定の結果trueなら[::Type_1 = _Ty1]
//_Ty2::_Ty1との判定に使用する型
...
//仕様
//[same_as<_Ty1,_Ty2>]の結果がtrueなら[_Ty1],falseなら[invalid_t]
//
//template
...
//仕様
//[not_same_as<_Ty1,_Ty2>]の結果がtrueなら[_Ty1],falseなら[invalid_t]
//
//template
//_Ty1::判定の結果trueなら返るタイプ
//_Ty2::_Ty1との判定に使用する型
...
//仕様
//[convertible_to<_From, _To>]の結果がtrueなら[_From],falseなら[invalid_t]
//
//template
...
//仕様
//[not_convertible_to<_From, _To>]の結果がtrueなら[_From],falseなら[invalid_t]
//
//template
//_From::判定の結果trueなら返るタイプ
//_To::_Fromとの判定に使用する型
