	...
	struct I_Request
	{
		...
		struct I_Request_Data
		{
			using type = Request_Core<
				typename S_Request_args<typename T_Request::request_args, typename T_Fn_Data::bind_args>::type,
				typename S_Request_pointer<typename T_Request::request_pointer, typename T_Fn_Data::pointer>::type>;
		};
