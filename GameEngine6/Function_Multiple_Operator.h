...
//				requires (S_MethodData<T_Parent>::Method_Type == E_Method_T::Function) ||
//			(S_MethodData<T_Parent>::Method_Type == E_Method_T::Static_Method)
//			constexpr S_Function_Multiple_Operator(T_Parent method, T_BindArgs... args) :
//				Function_Single<T_FlontFn, T_BindArgs...>(method, args...) {}
//
//			template<class T_Common_Pointer, class T_Parent>
//				requires (S_MethodData<T_Parent>::Method_Type == E_Method_T::Function) ||
//			(S_MethodData<T_Parent>::Method_Type == E_Method_T::Static_Method)
//			constexpr S_Function_Multiple_Operator(T_Common_Pointer* common_p, T_Parent method, T_BindArgs... args) :
//				Function_Single<T_FlontFn, T_BindArgs...>(method, args...) {}
//
//			template<class T_Common_Pointer, class T_Parent, class Dedicated_Pointer>	
//				requires (S_MethodData<T_Parent>::Method_Type == E_Method_T::Class_Method)
//			constexpr S_Function_Multiple_Operator(T_Common_Pointer* common_p, Dedicated_Pointer* dedicated_p,T_Parent method,T_BindArgs... args) :
//				Function_Single<T_FlontFn, T_BindArgs...>(dedicated_p, method, args...){}
//
//			template<class T_Common_Pointer, class T_Parent, class ...TP_Fn_Inners>
//				requires (S_MethodData<T_Parent>::Method_Type == E_Method_T::Class_Method)
//			constexpr S_Function_Multiple_Operator(T_Common_Pointer* common_p, T_Parent method, T_BindArgs... args) :
...
//
//			template<class T_Parent, class ...MT_Fn_Parts>
//				requires (S_MethodData<T_Parent>::Method_Type == E_Method_T::Function) || 
//						 (S_MethodData<T_Parent>::Method_Type == E_Method_T::Static_Method)
//			constexpr S_Function_Multiple_Operator(T_Parent method, T_BindArgs... args, MT_Fn_Parts... fn_Parts) :
//				Function_Single<T_FlontFn, T_BindArgs...>(method, args...),
//				S_Function_Multiple_Operator<S_Parameter<T_Fns...>>(fn_Parts...) {}
//
//			template<class T_Common_Pointer, class T_Parent, class ...MT_Fn_Parts>
//				requires (S_MethodData<T_Parent>::Method_Type == E_Method_T::Function) || 
//						 (S_MethodData<T_Parent>::Method_Type == E_Method_T::Static_Method)
//			constexpr S_Function_Multiple_Operator(T_Common_Pointer* common_p,T_Parent method,T_BindArgs... args, MT_Fn_Parts... fn_Parts) :
//				Function_Single<T_FlontFn, T_BindArgs...>(method, args...),
...
//				S_Function_Multiple_Operator<S_Parameter<T_Fns...>>(common_p, fn_Parts...) {}
//
//			template<class T_Common_Pointer, class T_Parent, class Dedicated_Pointer, class ...MT_Fn_Parts>
//				requires (S_MethodData<T_Parent>::Method_Type == E_Method_T::Class_Method)
//			constexpr S_Function_Multiple_Operator(T_Common_Pointer* common_p, Dedicated_Pointer* dedicated_p, T_Parent method, T_BindArgs... args, MT_Fn_Parts... fn_Parts) :
//				Function_Single<T_FlontFn, T_BindArgs...>(dedicated_p,method, args...),
//				S_Function_Multiple_Operator<S_Parameter<T_Fns...>>(common_p, fn_Parts...) {}
//			
//		};
