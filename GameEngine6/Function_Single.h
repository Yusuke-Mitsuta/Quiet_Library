...
namespace N_Function
{
	...
	template<not_same_as<invalid_t> T_Fns, class ...TP_Args>
...
//	template<not_same_as<invalid_t> T_Fns, class ...TP_Args>
//	class Function_Single :
//		public N_Function::IS_Function_Single_Operator<T_Fns, TP_Args...>::Type
//	{
//	protected:
//
//		using MethodData = N_Function::S_MethodData<T_Fns, TP_Args...>;
//
//		using FunctionOperator = N_Function::IS_Function_Single_Operator<T_Fns, TP_Args...>::Type;
//
//	public:
//
